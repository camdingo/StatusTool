#ifndef QUERYRESOURCE_H
#define QUERYRESOURCE_H
...
private :
    ...
    std::vector<int> _lastTotalUser;
    std::vector<int> _lastTotalUserLow;
    std::vector<int> _lastTotalSys;
    std::vector<int> _lastTotalIdle;
    ...
    std::vector<std::vector<float> > _percentages;
